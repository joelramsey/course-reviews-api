...
import com.ramsey.course.CourseRepository;
import com.ramsey.review.Review;
import com.ramsey.user.User;
import com.ramsey.user.UserRepository;
...
public class DatabaseLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        Course course = new Course("Java Basics", "https://www.ravenanalytics.io");
        ...
        users.save(students);
        users.save(new User("joelramsey", "Joel", "Ramsey", "12345678", new String[]{"ROLE_USER", "ROLE_ADMIN"}));
